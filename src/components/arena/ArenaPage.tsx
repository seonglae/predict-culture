        ...
        <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/50 backdrop-blur-[2px] px-4 overflow-y-auto py-8 z-50">
                ...
                >
                  ...
                  <span className="px-4 py-1.5 rounded-full bg-white/10 border border-white/20 text-[13px] font-mono text-white/60 font-medium">
                  ...
                  {beliefs?.map((belief, i) => {
                    ...
                    return (
                      <motion.button
                        ...
                        className="px-3 py-2.5 rounded-xl border border-white/10 bg-white/[0.04] backdrop-blur-xl text-left hover:bg-white/[0.08] hover:border-white/20 transition-all group cursor-pointer"
                      >
                        <p className="text-[9px] font-mono text-white/30 mb-0.5">
                          {matchingBot?.name ?? `Bot ${i + 1}`}
                        </p>
                        <p className="text-[12px] font-mono text-white/70 group-hover:text-white/90">
                          &quot;{belief}&quot;
                        </p>
                      </motion.button>
                    );
          ...
          {phase === "running" && sceneConfig && (
            ...
            >
              ...
              <div className="hidden md:block w-[320px] h-full shrink-0">
                <CultureSidebar
                  bots={bots}
                  messages={messages}
